        ...
        <div className="container mx-auto ">
            ...
            <div className="my-5">
                <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2">
                    <div>
                        <h2 className="py-3 text-3xl">Order Successful!</h2>
                        <p className="mb-4">
                            Thank you for placing your order! We have received
                            your payment and confirmed your order. Your items
                            will be shipped within three business days. Please
                            keep an eye on your provided contact details for
                            delivery notifications. If you have any questions or
                            need assistance, feel free to contact our customer
                            service team. Thank you once again for your support,
                            and we wish you a pleasant shopping experience!
                        </p>
                        <Link
                            to="/"
